    ...
    return(
      <Jumbotron style = {{backgroundColor: "#050401", margin: '0vh'}} fluid>
        <Jumbotron className = "center" style = {{backgroundColor: "#360CAA", margin: '10vh'}}>
          <div fluid className = "center" style = {{justifyContent: 'center', alignItems: 'center', display: 'flex'}}><img height='300vh' className="img-responsive" style = {{alignSelf: 'center'}} src={cover}  alt="cover"/></div><br/>
